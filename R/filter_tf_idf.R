...
#' @param min A minimal threshold that a word tf-idf must exceed.
...
#' \url{file:///C:/Users/Tyler/Downloads/v40i13.pdf}
#' @examples
...
#' filter_tf_idf(y, .001)
filter_tf_idf <- function(x, min = 0.002){
...
filter_tf_idf.DocumentTermMatrix <- function(x, min = 0.002){
...
filter_tf_idf.TermDocumentMatrix  <- function(x, min = 0.002){
